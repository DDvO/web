...
Diese 1000 Watt pro Quadratmeter dienen auch als Referenzwert für
...
beste Ausbeute] bekommt man in süddeutschen Breitengraden bei
Ausrichtung nach Süden und mit ca. 38° Neigungswinkel (relativ zur Waagerechten).
...
Man hat durch einen gewisse "Überdimensionierung" auch zu ungünsten Tages- und
...
image:Solar_Timeseries_SA2_38deg_0deg_2005_2020.png[#Bild: Modellrechnung Kappung von 1035 Wp auf 600 W Ausgang bei 20.5% Systemverlust#,1000,align=left]
Hier das Ergebnis einer Modellrechung für den Raum München basierend auf
den https://re.jrc.ec.europa.eu/pvg_tools/de/#HR[stündlichen Daten des PVGIS]
für die Jahre 2005 - 2020 und
einem der Einfachheit halber als konstant angenommenen Gesamtverlust von 20,5%,
der u.A. den von PVGIS standardmäßig einberechneten Systemverlust von 14% beinhaltet.
(Eigentlich müsste man die Verluste abhängig von Temperatur usw. simulieren,
aber die Vereinfachung macht nur einen Fehler von ca. +/- 6% aus.) +
Ergebnis: Bei Verwendung von 1035 Wp Modulen,
die eigentlich zu einem Ertrag von etwa 1145 kWh führen würden,
macht der Verlust durch Kappung auf 600 W Ausgangsleistung nur etwa 77 kWh aus.
Das erklärt sich damit, dass die Kappung realistisch bei nur ca. 7% der
(Gesamt-)Stunden stattfindet und der dadurch verursachte Verlust
im Schnitt nur etwa 0,13 kWh pro "gekappter" Stunde ausmacht.
...
-- jedenfalls die neueren für die Abrechnung aktuell verwendenten Stromzähler
...
Amortisierung bei 75% Eigenverbrauch in weniger als 2 Jahren.
...
Zu beachten ist noch, dass die Regler-Eingangspannung je nach Modell bis zu 5 V
...
bei einer Ladeschlusspannung von ca. 14,5 V einer LiFePO4-Batterie
