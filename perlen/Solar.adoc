...
Vermutlich arbeiten auch Wechselrichter mit 24 V Eingangsspannung etwas
effizienter als solche für 12 V. +
Allerdings gibt es weit mehr Geräte, die direkt mit 12 V betrieben werden können
als mit 24 V.
