...
Außerdem gibt es Verluste, wenn die Zellen nicht senkrecht zur Einstrahlung
ausgerichtet, verschattet, verschmutzt oder zu warm sind.
...
und mit ca. 38° Neigungwinkel (relativ zur Waagerechten).
Genaueres kann man https://re.jrc.ec.europa.eu/pvg_tools/de/[Standardort-spezifisch berechnen].
...
Flexible Panels sind etwas teurer als starre,
dafür aber viel leichter und nur wenige Millimeter dick.
Sie sind meist auch deutlich kleiner --
typischerweise 1,2 m * 0,5 m bei einer Nennleistung von 100 Wp.
...
Wohnmobile. Generell sind monokristalline Zellen zu bevorzugen,
auch wenn sie etwas teurer sind, weil sie einen höheren Wirkungsgrad haben.
...
und einen geringen Ruhe-/Leerlaufstromverbrauch
...
mit angeblich 93% Wirkungsgrad und nur 2 W Standby-Vebrauch, ca. 186€
