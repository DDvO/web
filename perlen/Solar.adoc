...
nach Umwandlung durch einen Wechselrichter
...
Wenige große Module sind technisch und wirtschaftlich günstiger als viele kleine.
...
Solarmodule kann man wie bei Batteriezellen seriell und/oder parallel verbinden,
