...
haben meist eine recht geringen Nennleistung von bis zu 600 Wp.
...
Die nominale Leistung der verwendeten Solarmodule kann aber durchaus etwas
größer (z.B. 800 Wp) sein, denn in der Praxis wird diese kaum erreicht
und außerdem hat der Solarwechselrichter auch Verluste.
...
(wobei der Strompreis derzeit ja kräftig steigt),
...
* 4 × https://www.ebay.de/itm/134183861850[130 Wp flexible 18 V Solarpanels], für 475€ +
