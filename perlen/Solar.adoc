...
Die maximale Einstrahlung auf der Erde mittags bei klarem Himmel in Bodennähe
auf eine Fläche senkrecht zum Sonnenstand liegt bei
http://www.energieinfo.de/eglossar/sonneneinstrahlung[1,37 kW/m^2^
...
und ist je nach Wetter, Tages- und Jahreszeit sehr variabel.
Als Referenzwert für die Nennleistung von Solarmodulen in Wp (Watt peak)
dienen 1000 Watt pro Quadratmeter.
...
aber die Vereinfachung macht nur einen relativen Fehler von ca. +/- 6% aus.) +
Ergebnis: Bei Verwendung von 1000 Wp Modulen,
