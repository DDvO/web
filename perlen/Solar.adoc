...
arbeiten saldierend (d.h. bilden die Gesamtsumme von Verbrauch und Erzeugung,
...
Größenordnung und dem zeitlichen Nutzungsprofil besonders geeignet sind.
...
lohnt sich aber nur, wenn man die Batterie schon aus anderen Gründen hat,
z.B. für eine Notstromversorgung oder als Fahrzeugbatterie.
...
image:Wasserspeicher.jpg[%Bild: Wasserspeicher als Analogie%,400,align=left]
Hier als Analogie eine Skizze eines automatischen Wasserspeichers,
der z.B. über die Dachrinne eines Hauses gespeist wird.
Wenn er voll genug ist, läuft das Wasser über die rechte innere Begrenzung
und lässt die Kugel aufschwimmen, die bis dahin den Auslass blockiert hat.
Dann fließt das Wasser aus dem Speicher langsam und gleichmäßig nach unten aus.
...
Zusätzlich ist der Speicher am Einlass mit einem Überlaufschutz ausgestattet,
der die Wasserzufuhr stoppt, wenn der Speicher sehr voll ist und das Wasser
durch den kleinen Auslass nicht schnell genug abfließt.
...
Wirtschaftlich rentabel für die Nutzung zu Hause kann das
bei den derzeitigen Preisen nur sein, wenn man eine geeignete Batterie schon
aus anderen Gründen (z.B. für den mobilen Einsatz in einem Fahrzeug) hat
und die zusätzliche Nutzungsart auch zeitlich alternativ dazu möglich ist.
...
%Bild: Bypass-Dioden bei der Arbeit%,768,align=left]
...
* 2 × 400 Wp starre SSP link:Datenblatt_ECO-380-400M-66SA.pdf[
  EcoDelta - ECO-400M-66SA] mit besonders hoher Effizienz: 213 Wp/m², ca. 540€ +
// inkl. Versand
...
oder 2 × 310 Wp sehr langlebige flexible Solarmodule link:Datenblatt_Sunman_flexible_310W.pdf[
...
https://www.ebay.de/itm/124731502486[SG1000MQ], ca. 200€ +
// https://www.ebay.de/itm/154235411613?var=454341223819
oder 4 × 400W Micro Solar Wechselrichter
https://de.made-in-china.com/co_skycorpsolar/product_Deye-Micro-Inverter-1600W-Sun1600g3-EU-230-Micro-Solar-Inverter-on-Grid-Solar-Home-System-Inverter_ysyyygenig.html[Deye Sun1600g3-EU-230], ca. 320€
